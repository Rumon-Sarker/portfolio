...
const Header = () => {
    ...
    return (
        <div className="flex max-w-[1420px] w-full h-auto lg:mt-[61px] sm:mt-[40px] mt-[25px] lg:px-0 sm:px-2 px-2 mx-auto items-center justify-between">
            ...
            <nav className="lg:flex hidden items-center xl:gap-[24px] lg:gap-[16px]">
                <ul className="flex xl:gap-[12px] lg:gap-[6px] text-secondary items-center">
                    {navItems.map((item) => (
