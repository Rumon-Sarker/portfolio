            ...
            <div className="flex lg:flex-row flex-col-reverse items-center justify-between w-full lg:mt-[120px] mt-[20px]">
                ...
                <div className="flex flex-col">
                    <div className="flex flex-col justify-center max-w-[714px] w-full gap-2 lg:pr-[9px] pr-0">
                        <p className="lg:text-[24px] text-[20px] font-[600] leading-[100%] font-poppins lg:pl-[7px] pl-0 tracking-[0.03em]">Hi I am </p>
                        ...
                        <div className="flex flex-col">
                            <h1 className="text-start lg:text-[100px] md:text-[80px] sm:text-[60px] text-[50px] font-[700] font-poppins leading-[120%] tracking-[0.03em]">UI & UX </h1>
                            <h1 className="lg:text-end text-center lg:text-[100px] md:text-[80px] sm:text-[60px] text-[50px] font-[700] font-poppins leading-[120%] tracking-[0.03em]">Designer </h1>
                        </div>
                    </div>
                    <p className="lg:text-[21px] md:text-[18px] text-[16px] max-w-[698px] w-full lg:pt-[28px] md:pt-[20px] pt-[12px]  lg:pl-[7px] pl-0 font-[400] leading-[100%] tracking-[0.03em] text-justify ">Lorem ipsum dolor sit amet consectetur. Tristique amet sed massa nibh lectus netus in. Aliquet donec morbi convallis pretium. Turpis tempus pharetra</p>
