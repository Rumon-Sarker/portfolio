            ...
            <div className="flex items-center justify-between w-full mt-[120px]">
                ...
                <div className="flex flex-col ">
                    <div className="flex flex-col justify-center max-w-[714px] w-full gap-2 pr-[9px]">
                        ...
                        <div className=" flex flex-col">
                            <h1 className="text-start text-[100px] font-[700] font-bold font-poppins leading-[120%] tracking-[0.03em]">UI & UX </h1>
                            <h1 className="text-end text-[100px] font-[700] font-bold font-poppins leading-[120%] tracking-[0.03em]">Designer </h1>
                        </div>
                    </div>
                ...
                <div className="flex flex-col gap-[32px]">
                    ...
                    <div className="flex gap-[25.03px] justify-center">
                        {/* social media icons */}
